...
HD_PWD='C:/Users/Jayant/Desktop/HighSpeedArithmetic_project/HighSpeedArithmetic_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallace16.tcl
